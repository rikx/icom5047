      ...
      if(($('#container_plumbjs').find("textarea")).length == 0){
        ...
        if($('input[name=ready_radios]:checked').val() == 1){
    	    ...
    	    if(end_points.first_id != -1 && end_points.end_id != -1){
              ...
              alert('Verifique que todas las preguntas y recomendaciones tienen una conección hacia otro elemento. Las preguntas de selección multiple necesitan por lo menos 2 conexiones y las conditionales exactamente 2 conexiones.');
            }
    	    } else {
