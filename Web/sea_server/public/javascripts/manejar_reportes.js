$(document).ready(function(){
    ...
    function populate_info_panel(){
     ...
     $('#reporte_info_id').html("<a href='/users/admin/reportes/" + firstElement.report_id + "'> Reporte " +  firstElement.report_id + "</a>");
 ...
 $reportes_list.on('click', 'tr td a.show_info_reporte', function(e){
   ...
   var thisUserObject = reportes_array[arrayPosition];
    ...
    //#info_panel_heading
    $('#reporte_info_id').html("<a href='/users/admin/reportes/" + thisUserObject.report_id + "'> Reporte " + thisUserObject.report_id + "</a>");
...
window.location.href = '/users/admin/reportes/'+this_reporte_id;
