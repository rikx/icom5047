...
public class MainActivity extends FragmentActivity implements Toolbar.OnMenuItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		options = toolbar.getMenu();SharedPreferences sharedPref = this.getSharedPreferences(
				getString(R.string.preference_file_key), Context.MODE_PRIVATE);
		username= sharedPref.getString(getString(R.string.key_saved_username), "");
...
//                sync();
	...
	private void showAppointmentsList() {
		String subtitle = username + " - " + getString(R.string.appointments);
	...
	private void showReportsList() {
		String subtitle = username + " - " +getString(R.string.reports);
		toolbar.setSubtitle(subtitle);
		FragmentManager manager = getFragmentManager();
		FragmentTransaction transaction = manager.beginTransaction();
	...
	private void showPeopleList() {
		String subtitle = username + " - " +getString(R.string.people);
		toolbar.setSubtitle(subtitle);
		FragmentManager manager = getFragmentManager();
		FragmentTransaction transaction = manager.beginTransaction();
	...
	private void showLocationsList() {
		String subtitle = username + " - " +getString(R.string.locations);
		toolbar.setSubtitle(subtitle);
		FragmentManager manager = getFragmentManager();
		FragmentTransaction transaction = manager.beginTransaction();
...
//        }
	...
	private void newReport() {
		...
		if (allow) {
			...
			FragmentManager manager = getFragmentManager();
			LocationDetailsFragment locDetails = (LocationDetailsFragment) manager
